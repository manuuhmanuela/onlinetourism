...
if(isset($_POST['submit2']))
{
    ...
    if($lastInsertId)
    {
        // Redirect to mpesa.php with booking details
        header("Location: mpesa.php?bookingid=".$lastInsertId."&pkgid=".$pid."&amount=800");
        exit();
    }
    else 
    {
                ...
                <ul>
                    ...
                    {?>
                        <li class="spe" align="center">
                            <button type="submit" name="submit2" class="btn-primary btn">Book & Pay via M-Pesa</button>
                        </li>
                        <?php } else {?>
